...
/*
array(4) {
  ["name"] => string(12) "buttonManage"
  ["onclick"] => string(83) "$(this).css('font-weight', 'bold');$(this).siblings().css('font-weight', 'normal');"
  ["href"] => string(1) "#"
  ["ajax"] => array(5) {
    ["type"] => string(4) "POST"
    ["update"] => string(7) "#wizard"
    ["beforeSend"] => string(124) "function(){
                                      $("#wizard").addClass("srbacLoading");
                                  }"
    ["complete"] => string(127) "function(){
