...
class AuthitemController extends SBaseController {
  ...
  public function actionList() {
    // Get selected type
	//debug(Yii::app()->user->getState("selectedType"));
    $selectedType =
	...
	//debug(AuthItem::model()->count($criteria));
  ...
  public function actionManage() {
	...
	//$criteria->condition = "name like 'sun%' ";
	//debug(Yii::app()->request->getParam('page', 0) - 1);
    if (!Yii::app()->request->isAjaxRequest) {
      Yii::app()->user->setState("currentPage", Yii::app()->request->getParam('page', 0) - 1);
    }
	//debug($criteria);
