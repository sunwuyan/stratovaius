 ...
 * @since 1.0.0
 */
// debug(Yii::app()->user->hasFlash('updateName'));
 ?>
...
<div class="controlPanel">
  ...
  <div style="margin: 0px">
    ...
    $input=$this->widget('CAutoComplete',
            array(
                'name'=>'name',
                'max'=>10,
                'delay'=>300,
...
<table class="srbacDataGrid">
  <tr>
    ...
    <th>
       <?php   //debug(Yii::app()->user->getState("selectedType"));
