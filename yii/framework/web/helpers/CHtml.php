...
/*
array(2) {
  ["for"] => string(18) "LoginForm_password"
  ["class"] => string(8) "required"
}
*/
...
EOD;
	...
	public static function activeLabel($model,$attribute,$htmlOptions=array())
	{
		...
		#p($for);#string(18) "LoginForm_username"
		#p($label);#string(8) "Username"
...
/*
array(2) {
  ["empty"] => string(10) "fuck you@!"
  ["options"] => array(1) {
    [1] => array(2) {
      ["disabled"] => bool(true)
      ["label"] => string(5) "Draft"
    }
  }
}
*/
...
<option value="1" disabled="disabled" label="Draft">Draft</option>
...
/*
array(2) {
  ["name"] => string(12) "Post[status]"
  ["id"] => string(11) "Post_status"
}
*/
		self::clientChange('change',$htmlOptions);
		if($model->hasErrors($attribute))
	...
	public static function error($model,$attribute,$htmlOptions=array())
	{
		self::resolveName($model,$attribute); // turn [a][b]attr into attr
                #p(self::resolveName($model,$attribute)); #string(19) "LoginForm[username]"
