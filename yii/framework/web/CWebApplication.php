 ...
 * @since 1.0
 */
class CWebApplication extends CApplication //property,component,
{
	/**
	...
	private $_controllerPath; #pc
	private $_viewPath;#pv
	private $_systemViewPath;#pvs
	private $_layoutPath;#pvl
	private $_controller;
	private $_theme;
...
#p($caseSensitive);#bool(true)
		$route.='/'; #string(10) "site/login/"
	...
	{
		#p($pathInfo);#string(16) "page/view/about/"
