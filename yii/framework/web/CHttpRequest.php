...
class CHttpRequest extends CApplicationComponent
{
	...
	{
		// normalize request
		if(function_exists('get_magic_quotes_gpc') && get_magic_quotes_gpc()) //return false;
		{
			#p("hello world");
			if(isset($_GET))
	 ...
	 */
	public function getUrl() #string(31) "/notepad/index.php?r=site/index"
	{
	 ...
	 * @see setHostInfo
	 */
	public function getHostInfo($schema='') #string(8) "http://y"
	{
	 ...
	 * @see setScriptUrl
	 */
	public function getBaseUrl($absolute=false) //返回域名之后入口脚本之前的部分 e.g string(5) "/blog"
	{
	 ...
	 */
	public function getScriptUrl() #string(15) "/blog/index.php"
	{
	...
	{
		//p($_SERVER['REQUEST_METHOD']); //string(3) "GET"
	...
	public function sendFile($fileName,$content,$mimeType=null,$terminate=true)
	{
		...
		header('Pragma: public'); #共享缓存
		header('Expires: 0'); #使用后立即过期，back后页面失效
		header('Cache-Control: must-revalidate, post-check=0, pre-check=0');
		header("Content-type: $mimeType");
		if(ob_get_length()===false)
			header('Content-Length: '.(function_exists('mb_strlen') ? mb_strlen($content,'8bit') : strlen($content)));
		header("Content-Disposition: attachment; filename=\"$fileName\"");#inline
...
/*
array(3) {
  ["4b608ef8cfb12c45871c8a4b5237c9fc"] => string(102) "cabddf252dda25d1bebff1f25c26d176d73ebd76a:4:{i:0;s:5:"admin";i:1;s:5:"admin";i:2;i:2592000;i:3;a:0:{}}"
  ["YII_CSRF_TOKEN"] => string(88) "0207a05671232e878ade2187b4f21582df458cefs:40:"6b1ff094cffbdd35580802b768cd0f7f829c7abf";"
  ["PHPSESSID"] => string(26) "h2agoe9fs9uo9pvo7ucu0r9ds1"
}
*/
