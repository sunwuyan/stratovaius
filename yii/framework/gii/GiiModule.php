...
array(5) {
  ["controller"] => array(2) {
    ...
    ["templates"] => array(1) {
      ["default"] => string(69) "C:\wamp\www\yii\framework\gii\generators\controller\templates\default"
    }
  }
  ["crud"] => array(2) {
    ["class"] => string(33) "gii.generators.crud.CrudGenerator"
    ["templates"] => array(1) {
      ["default"] => string(63) "C:\wamp\www\yii\framework\gii\generators\crud\templates\default"
    }
  }
  ["form"] => array(2) {
    ["class"] => string(33) "gii.generators.form.FormGenerator"
    ["templates"] => array(1) {
      ["default"] => string(63) "C:\wamp\www\yii\framework\gii\generators\form\templates\default"
    }
  }
  ["model"] => array(2) {
    ["class"] => string(35) "gii.generators.model.ModelGenerator"
    ["templates"] => array(1) {
      ["default"] => string(64) "C:\wamp\www\yii\framework\gii\generators\model\templates\default"
    }
  }
  ["module"] => array(2) {
    ["class"] => string(37) "gii.generators.module.ModuleGenerator"
    ["templates"] => array(1) {
      ["default"] => string(65) "C:\wamp\www\yii\framework\gii\generators\module\templates\default"
    }
  }
}
*/
...
*/
		...
		for($i=$n-1;$i>=0;--$i)
		{
			...
			$names=scandir($path);
#p($path); #string(40) "C:\wamp\www\yii\framework\gii\generators"
#p($names);
/*
array(7) {
  [0] => string(1) "."
