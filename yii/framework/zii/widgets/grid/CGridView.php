...
class CGridView extends CBaseListView
{
	...
	public function registerClientScript()
	{
		$id=$this->getId();
		#p($id);#string(3) "yw0"
		#p($this->ajaxUpdate);#NULL
		#p($this->ajaxUpdate===false);#bool(false)
...
array(7) {
  ...
  ["ajaxVar"] => string(4) "ajax"
  ["pagerClass"] => string(5) "pager"
  ["loadingClass"] => string(17) "grid-view-loading"
  ["filterClass"] => string(7) "filters"
  ["tableClass"] => string(5) "items"
  ["selectableRows"] => int(1)
}
*/
#p($this->ajaxUrl);#NULL
...
*/
	...
	{
		#p($this->dataProvider->getItemCount());
