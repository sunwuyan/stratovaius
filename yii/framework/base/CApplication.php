 ...
 * @since 1.0
 */
abstract class CApplication extends CModule //property,component,
{
	/**
	 ...
	 */
	public function __construct($config=null) #srsapircapi
	{
		...
		{
			$this->setBasePath($config['basePath']); //CApplication#setBasePath()
...
/*
array(5) {
  ["system"] => string(25) "C:\wamp\www\yii\framework"
  ["zii"] => string(29) "C:\wamp\www\yii\framework\zii"
  ["application"] => string(26) "C:\wamp\www\blog\protected"
  ["webroot"] => string(16) "C:/wamp/www/blog"
  ["ext"] => string(37) "C:\wamp\www\blog\protected\extensions"
}
*/
		$this->preinit(); //CModule#preinit(),but do nothing;

		$this->initSystemHandlers();
		$this->registerCoreComponents();
		
		#p($config);
		$this->configure($config); //CModule#configure();
		
		//p(Yii::getImports());
/*
array(2) {
  ["application.models.*"] => string(33) "C:\wamp\www\blog\protected\models"
  ["application.components.*"] => string(37) "C:\wamp\www\blog\protected\components"
}
*/
		//p(Yii::app()->getParams());
/*
object(CAttributeCollection)#2 (5) {
  ...
  ["_d":"CMap":private] => array(7) {
    ["title"] => string(11) "My Yii Blog"
    ["adminEmail"] => string(21) "webmaster@example.com"
    ["postsPerPage"] => int(10)
    ["recentCommentCount"] => int(10)
    ["tagCloudCount"] => int(20)
    ["commentNeedApproval"] => bool(true)
    ["copyrightInfo"] => string(36) "Copyright &copy; 2009 by My Company."
  }
  ["_r":"CMap":private] => bool(false)
...
*/
	...
	public function loadGlobalState()
	{
		...
		#p($this->_globalState); #return an array
	...
	protected function registerCoreComponents()
	{
		...
		$this->setComponents($components); //CModule#setComponents(...)
	}
}
